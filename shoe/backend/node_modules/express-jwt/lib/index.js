...
// module.exports = function(options) {
//   if (!options || !options.SECRET_KEY) throw new Error('secret should be set');

//   if (!options.algorithms) throw new Error('algorithms should be set');
//   if (!Array.isArray(options.algorithms)) throw new Error('algorithms must be an array');

//   var secretCallback = options.SECRET_KEY;
...
//     async.waterfall([
//       function getSECRET_KEY(callback){
//         var arity = secretCallback.length;
//         if (arity == 4) {
//           secretCallback(req, dtoken.header, dtoken.payload, callback);
//         } else { // arity == 3
...
//         }
//       },
//       function verifyToken(SECRET_KEY, callback) {
//         jwt.verify(token, SECRET_KEY, options, function(err, decoded) {
//           if (err) {
//             callback(new UnauthorizedError('invalid_token', err));
//           } else {
//             callback(null, decoded);
